...
/*
 * Part 2 of day 7: https://adventofcode.com/2021/day/7
 */
...
horizontalPositions.forEach { crabPosition ->
	for (candidatePosition in 0..maxPosition) {
		val distance = abs(crabPosition - candidatePosition)
		// This is the formula of the sum of first n natural numbers
		val consumedFuel = (distance * distance + distance) / 2
